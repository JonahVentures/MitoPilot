...
Simply put, all you need is a GenBank formatted file (`.gb`) containing annotated mitogenomes for decently close relatives. This file can be downloaded from a GenBank query in a web browser. 
